...
<html lang="en">
  <head>
    ...
    {{-- <link rel="icon" href="{{ asset('storage/public/asset/key.png') }}" type="image/x-icon"> --}}
</head>
<body>
            ...
            <div class="card">
                ...
                <form action="{{ route('login') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control" id="name" placeholder="Masukan Username" value="{{ old('name') }}" required>
                    </div>
                    <div class="mb-3">
